...
Import and clean the FAS datasets. - Change sex from numeric to
character - Move litter number to the first column - Separate treatment
type and treatment day from ‘Group’ variable
...
Next up, time to join them! Left join will naturally look for a key, but
be explicit.
