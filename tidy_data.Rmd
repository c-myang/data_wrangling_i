...
Bind all the rows together (stack all datasets together), clean names, relocate, and pivot longer:
...
- Change sex from numeric to character
- Move litter number to the first column
- Separate treatment type and treatment day from 'Group' variable
...
Left join will naturally look for a key, but be explicit.
